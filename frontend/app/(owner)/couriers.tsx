  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Pressable testID="add-courier-btn" onPress={() => setShow(true)} style={styles.headerAdd}>
      ...
      {loading ? <ActivityIndicator color={theme.colors.brand} style={{ marginTop: 40 }} /> : (
        <FlatList
          ...
          ListEmptyComponent={<Text style={styles.empty}>No couriers yet. Tap + to add.</Text>}
        />
      )}
        ...
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
          <View style={styles.modalBg}>
            <View style={styles.modal}>
              <Text style={styles.modalTitle}>{t('addCourier')}</Text>
              ...
              <TextInput testID="courier-password-input" style={styles.input} placeholder={t('password')} placeholderTextColor={theme.colors.onSurfaceTertiary} secureTextEntry value={form.password} onChangeText={(v) => setForm({ ...form, password: v })} />
              ...
              <View style={styles.actions}>
                ...
                <Pressable testID="courier-save-btn" onPress={submit} disabled={saving} style={[styles.btn, styles.btnSave]}>
